...
contract DapniProc {
    ...
    string public dapniAccessAPIEndpoint;
    ...
    // Will be called in the event of death on DAPNI-ONE
    ...
    function isValidatorAuthorized() public view returns (bool) {
        ...
        // DAPNI-ACCESS will request signatures from validators
        // DAPNI-ACCESS will trigger this function by passing in the signatures
        // DAPNI-SECURE then authorize each transaction
    ...
    function requestProofOfDeath() public pure returns (bool) {
        ...
        // If false, request proof from DAPNI-ACCESS API using Chainlink

        // Signature is returned by DAPNI-ACCESS API
